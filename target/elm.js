...
var _luisantunesdeveloper$elm_subscriptions$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {ctor: '_Tuple2', _0: model + 2, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _luisantunesdeveloper$elm_subscriptions$Main$view = function (model) {
	return A2(
...
var _luisantunesdeveloper$elm_subscriptions$Main$init = {ctor: '_Tuple2', _0: 0, _1: _elm_lang$core$Platform_Cmd$none};
var _luisantunesdeveloper$elm_subscriptions$Main$KeyMsg = function (a) {
	return {ctor: 'KeyMsg', _0: a};
};
var _luisantunesdeveloper$elm_subscriptions$Main$subscriptions = function (model) {
	return _elm_lang$keyboard$Keyboard$presses(
		function (code) {
			return _luisantunesdeveloper$elm_subscriptions$Main$KeyMsg(code);
		});
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _luisantunesdeveloper$elm_subscriptions$Main$main === 'undefined' ? null : _luisantunesdeveloper$elm_subscriptions$Main$main);
